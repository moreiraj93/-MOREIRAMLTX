...
Billing is monthly via Stripe. Cancel any time through the subscription portal. Post-checkout, a WelcomeProModal confirms the active plan and renewal date.`,
  ...
  {
    id: 'mockj-domain-note',
    category: 'platforms',
    title: 'MockJ Domain Rule',
    keywords: ['mockj.online', 'mock-a.vercel.app', 'vercel preview', 'mockj domain rule', 'mockk official'],
    content: `When there is any conflict between URLs, MockJ should treat https://mockk.online/ as the official build. Vercel preview URLs and generated deployment URLs are temporary/stale unless Jenny explicitly marks one as active.`,
    lastUpdated: '2026-06',
  },
