...
const data: SEOPageData = {
  ...
  heroSub: 'Speak naturally and watch MockJ 4 execute — generate images, write code, answer questions, and read responses aloud with ElevenLabs voice.',
  ...
  features: [
    ...
    { icon: Volume2,      title: 'ElevenLabs Voice Output', desc: 'MockJ speaks back in a natural human voice with customizable speed (0.75× to 1.5×).' },
  ...
  faqs: [
    ...
    { q: 'What is Auto-Speak?', a: 'Auto-Speak automatically reads every AI response aloud using ElevenLabs TTS. Enable it from the sidebar toggle — great for hands-free use.' },
  ...
  comparison: {
    headers: ['MockJ 4', 'Siri', 'Google Ass.', 'Alexa'],
    rows: [
      ...
      { label: 'ElevenLabs Voice',    values: [true,  false, false, false] },
